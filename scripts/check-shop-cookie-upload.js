...
assert(fullSrc.includes('requestWillBeSentExtraInfo'));
assert(fullSrc.includes('ensureBridgeNetworkHeaderListeners'));
assert(fullSrc.includes('requestUrlById'));
assert(fullSrc.includes('requestWillBeSent'));
assert(fullSrc.includes('mergedNetworkHeaderCookie'));
